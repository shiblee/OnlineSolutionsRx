...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            // Add "per_unit" value to data
            $data['per_unit'] = $product_info['per_unit'];  // Pass per_unit value to the template
			...
			foreach ($results as $result) {
				...
				if ((float)$result['special']) {
					...
					// winter infotech countdown start
					$special_date = $this->model_catalog_product->getSpecialDate($product_id);
					(!empty($special_date)) ? ($end_date = $special_date['end_date']) : ($end_date = false);
