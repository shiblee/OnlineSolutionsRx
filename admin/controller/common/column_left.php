...
class ControllerCommonColumnLeft extends Controller {
    ...
    'href'     => $this->url->link('extension/module/contact_messages', 'user_token=' . $this->session->data['user_token'], true),
    'children' => array()
);
 ...
 // Add Blog Category menu
        ...
        $data['menus'][] = array(
    'id'       => 'menu-blogger',
    'icon'     => 'fa-newspaper-o', // Font Awesome icon
    'name'     => 'Manage Blog',
    'href'     => $this->url->link('extension/module/blogger', 'user_token=' . $this->session->data['user_token'] . '&module_id=42', true),
    'children' => array()
);
