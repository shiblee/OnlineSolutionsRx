...
class ControllerCatalogProduct extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			// echo "<pre>";($this->request->post);ext;
	...
	protected function getForm() {
		...
		if (isset($this->request->post['per_unit'])) {
		    $data['per_unit'] = $this->request->post['per_unit'];
		} elseif (!empty($product_info)) {
		    $data['per_unit'] = $product_info['per_unit'];
		} else {
		    $data['per_unit'] = '';
		}

				if (isset($this->request->post['product_position'])) {
			    $data['product_position'] = $this->request->post['product_position'];
			} elseif (!empty($product_info)) {
			    $data['product_position'] = $product_info['product_position'];
			} else {
